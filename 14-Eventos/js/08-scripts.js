...
// parrafo3.onclick = nuevaFuncion;   // esta forma sin parametros
parrafo3.onclick = function (){     // hacerlo asi para pasar parametros y no sea llamada al ejecutarse si no solo en el evento
    nuevaFuncion(1)
}
